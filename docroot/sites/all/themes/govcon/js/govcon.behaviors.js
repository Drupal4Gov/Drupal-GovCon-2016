(function ($) {
   ...
   */
  Drupal.theme.prototype.govconExampleButton = function (path, title) {
   ...
   */
  Drupal.behaviors.govconExampleBehavior = {
    attach: function (context, settings) {
      ...
      $('.some-selector', context).once('foo', function () {
        ...
        var $anchor = Drupal.theme('govconExampleButton', settings.myExampleLinkPath, settings.myExampleLinkTitle);
